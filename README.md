...
<head>
    ...
    <title> CG ESPORTS  - Professional FREE FIRE  Tournament App</title>
    ...
    <style>
        ...
        * {
        ...
        .hero {
            ...
            justify-content: space-between;
            position: relative;
            background: radial-gradient(circle at top right, rgba(255, 140, 0, 0.15), transparent 40%),
        ...
        .phone-screen {
            ...
            background-image: url('https://img.freepik.com/free-vector/gaming-ui-app-interface-template_23-2148705359.jpg');
        }
...
<!--
**cgesports/cgesports** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
